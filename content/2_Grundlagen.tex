...
erste Abschnitt dieses Kapitels befasst sich mit den verwendeten Maschinen und Komponenten der Robert Bosch GmbH.
...
Die Abbildung~\ref{fig:grundlagen_boschkwe} auf Seite~\pageref{fig:grundlagen_boschkwe} zeigt eine aktuelle
...
Lebensmitteln, wie zum Beispiel Pulver, Kaffee, Hähnchen sowie frischen und gefrorenen Produkten geeignet.
...
Das farbige Display dient zur Konfiguration der Maschine und kann die aktuelle Tätigkeit visualisieren. Auch können über
...
Teilnehmern herzustellen. In dem Test sind zwei echte Personen (B und C) und die zu testende Maschine involviert. Eine
...
Eines der wichtigsten Ziele von Big Data ist es, neue Informationen oder neue Erkentnisse aus den Daten zu gewinnen.
...
Machine Learning-Algorithmen ermöglichen es Computern, selbstständig zu lernen. Anstatt eine Vielzahl von Regeln in Form
von Quellcode zu programmieren, werden dafür statistische Algorithmen verwendet.
...
Sogenannte Labels helfen dabei, die einzelnen Gruppen zu benennen. Für Labels gibt es mehrere Beispiele wie
\enquote{Spam}, \enquote{zufriedener Kunde} und \enquote{unzufriedener Kunde}.
...
zu können, ohne dafür notwendige Produktlizenzen anderswo erwerben zu müssen.
...
Jedes Objekt besitzt eine globale und eindeutige Identifierierung (kurz ID), über die es gefunden werden kann. Außerdem
