...
Im Listing~\ref{listing_grundlagen_typescript} auf Seite~\pageref{listing_grundlagen_typescript} ist ein originaler
...
\begin{lstlisting}[language=JavaScript, caption=Unterschied zwischen JavaScript und TypeScript, label=listing_grundlagen_typescript]
    // JavaScript
