...
Auch ist entscheidend, dass man die Abfrage zu leeren Feldern auf die richtige Benamung und die Definition von
...
Damit ist gezeigt, dass die gebaute Architektur so modular ist, dass sie problemlos zu erweitern ist und neue Funktionen
darin eingebaut werden können. Dies galt es als Teilaufgabe in der Arbeit zu zeigen und beweisen.
