...
Dem resultierenden, trainierten Modell werden zu einem späteren Zeitpunkt die Inputs übergeben und die Targets kommen als
...
Das in einem vorangegangenen Kapitel erstellte und trainierte Modell kann man im Weiteren durch ein Deployment über eine
...
Ein Modell kann über mehrere Deployments verfügbar gemacht werden. So ist es möglich, die Last eines Webservices zu
...
Da der Entwickler das Modell in Kapitel~\ref{subsub:modeler_flow} auf Seite\pageref{subsub:modeler_flow} komplet
...
Wie Eingangs erwähnt soll ein Test zeigen, ob das selbe trainierte Modell unter verschiedenen Implementierungen die selben
