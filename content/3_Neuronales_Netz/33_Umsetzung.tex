...
Repository geschrieben hat, aktiviert sich die Toolchain selbstständig und lädt den entsprechenden Commit herunter.
...
Durch ein doppelten Klick auf das Modul öffnet sich die entsprechende Konfiguration. Als Titel kann man zum Beispiel
\enquote{Get Token} definieren. Als URL dient die Schnittstelle des Watson Studios,
\enquote{https://eu-gb.ml.cloud.ibm.com/v3/identity/token}.
...
\ref{ls:umsetzung_settoken} auf Seite \pageref{ls:umsetzung_settoken} zuständig.
