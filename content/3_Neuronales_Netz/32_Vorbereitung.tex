...
benamung des ersten Spaces ist \path{dev}. Dies ist die Abkürzung für \textit{developper}.
...
Mit einem Klick auf \path{Erstellen}, wird der Service Instanziiert und es erfolgt eine Weiterleitung zurück auf das
...
Schaltfläche \path{Get Started} in das Watson Studio gewechselt werden.
...
Über den Befehl \path{cf services} können alle instantiierten Services, welche sich in der vorher ausgewählten Organisation
...
Container später aufrufbar ist folgt dem Schema \path{https://service_name.mybluemix.net}.
