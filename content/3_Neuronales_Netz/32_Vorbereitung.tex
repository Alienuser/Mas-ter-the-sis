...
Abschließend muss im Watson Studio noch ein Projekt angelegt werden, in dem alle Daten und Informationen gesammelt werden
können. Dies kann über das Watson Studio Dashboard gemacht werden. Dazu wird dies über das IBM Bluemix Dashboard
aufgerufen.
